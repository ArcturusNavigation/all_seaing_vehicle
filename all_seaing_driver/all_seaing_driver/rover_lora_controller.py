...
class RoverLoraController(Node):
    def __init__(self):
        ...
        self.timer = self.create_timer(1 / 60, self.check_serial_data)
    ...
    def check_serial_data(self):
        if self.serial_port.in_waiting > 0:
            ...
            priority, x, y, angular, in_teleop, e_stopped, received_checksum = (
                struct.unpack("BdddBBB", serialized_data)
            )
...
def main(args=None):
    ...
    serial_control_subscriber.destroy_node()
    rclpy.shutdown()
