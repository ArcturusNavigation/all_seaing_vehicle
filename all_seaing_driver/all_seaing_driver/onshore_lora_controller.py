...
while running:
    ...
    control_text = font.render(
        f"Control - x: {control_msg['x']}, y: {control_msg['y']}, angular: {control_msg['angular']}",
        True,
        (255, 255, 255),
    )
    ...
    heartbeat_text = font.render(
        f"Heartbeat - in_teleop (enter): {heartbeat_msg['in_teleop']}, e_stopped (space): {heartbeat_msg['e_stopped']}",
        True,
        (255, 255, 255),
    )
