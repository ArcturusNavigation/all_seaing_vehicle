...
class JoyToControlNode(Node):
    def __init__(self):
        ...
        self.joy_control_pub = self.create_publisher(
    ...
    def vel_callback(self, msg):
        self.m_joy = msg
        self.m_control.y = self.m_joy.axes[0] * -0.6
        self.m_control.x = self.m_joy.axes[1] * 0.6
        self.m_control.angular = self.m_joy.axes[2] * -0.3
