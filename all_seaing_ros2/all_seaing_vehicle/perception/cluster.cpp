...
std::string Cluster::GetNMEA()
{
	...
	hull_nmea << this->GetNMEAHeader() << "," << this->GetROSHeader().stamp.sec << "." << this->GetROSHeader().stamp.nsec << "," << this->GetID();
...
void Cluster::ToROSMessage(std_msgs::Header in_ros_header, auvlab_msgs::CloudCluster &out_cluster_message)
{
