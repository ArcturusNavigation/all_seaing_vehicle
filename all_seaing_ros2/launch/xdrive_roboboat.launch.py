...
# sample launch file to run the roboboat sim with an xdrive boat and controller
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "with_control", default_value=TextSubstitution(text="True")
            ),
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    [vrx_gz_prefix, "/launch/roboboat.launch.py"]
                ),
                launch_arguments={
                    "world": "nbpark_follow",
