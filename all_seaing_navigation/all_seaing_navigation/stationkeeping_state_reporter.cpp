...
public:
    StationkeepingStateReporter() : Node("stationkeeping_state_reporter") {
        m_state_sub = this->create_subscription<all_seaing_interfaces::msg::GoalState>(
            "goal_state", 10,
            std::bind(&StationkeepingStateReporter::state_callback, this,
                      std::placeholders::_1));

        m_gateway_sub =
            this->create_subscription<protobuf_client_interfaces::msg::Gateway>(
                "/gateway_msg", 10,
                std::bind(&StationkeepingStateReporter::vel_callback, this,
                          std::placeholders::_1));
...
private:
    ...
    all_seaing_interfaces::msg::ControlMessage m_control =
    ...
    void state_callback(const all_seaing_interfaces::msg::GoalState &msg) {
        ...
        nav_msg.gateway_string = "GOAL_LAT=" + std::to_string(msg.goal_lat) +
                                 ", GOAL_LON=" + std::to_string(msg.goal_lon) +
    ...
    void vel_callback(const protobuf_client_interfaces::msg::Gateway &msg) {
        ...
        if (msg.gateway_key == "GOAL_HEADING") {
            ...
            m_control.angular_control_mode =
