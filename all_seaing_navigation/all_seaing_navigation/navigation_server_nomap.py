...
class NavigationServerNoMap(ActionServerBase):
    def __init__(self):
        super().__init__("navigation_server_nomap")

        self.declare_parameter("path_resolution", 0.1)
        self.res = self.get_parameter("path_resolution").get_parameter_value().double_value
